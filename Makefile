...
.PHONY: all clean cpu metal agent tools codenav \
	test-vectors test-agent-bash test-agent-checkpoint test-agent-context test-agent-edit test-agent-prefix-cache test-agent-repeat test-agent-trace test-agent-verify test-metal-smoke test-metal-logits test-metal-logits-concurrent test-metal-gqa-decode \
...
test-agent-prefix-cache: qw3-agent
	sh tests/test_agent_prefix_cache.sh
