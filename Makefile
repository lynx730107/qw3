...
.PHONY: all clean cpu metal agent tools codenav \
	test-vectors test-agent-bash test-agent-edit test-agent-repeat test-metal-smoke test-metal-logits test-metal-logits-concurrent test-metal-gqa-decode \
...
test-regression: test-agent-bash test-agent-edit test-agent-repeat test-metal-logits test-runtime-regression
